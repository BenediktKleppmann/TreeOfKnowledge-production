...
def test_page2(request):
    ...
    bla = list(Data_point.objects.filter(valid_time_start__gte=-1262307600, valid_time_start__lt=1577836800, object_id__in=['j1_14']) )
